...
### 100日チャレンジ85日目
プレイヤーの回転入力を再度チャレンジ。しかしやっぱり難しい

### 100日チャレンジ86日目
デブリがすべて無くなったときにテキスト表示
...
### 100日チャレンジ90日目
細かい修正を入れて完成と思ったけど、ゲームオーバー入れてなかった。

### 100日チャレンジ91日目
シールドアイコン表示

### 100日チャレンジ92日目
ダメージ時にシールドアイコン減らすのとゲームオーバー処理追加

### 100日チャレンジ93日目
デブリにぶつかったときの音が無かったので、小惑星のときと同じものを再生するように。
当初、考えていた部分はほぼ実装できたので、これで完成とする。

### 100日チャレンジ94日目
Godotのプロジェクトを単体で実行できるようにエクスポート
...
### 100日チャレンジ97日目
メニュー以外のオブジェクトを一時停止するように

### 100日チャレンジ98日目
メニューからタイトル画面に戻ったときに選択できないバグを修正

### 100日チャレンジ99日目
HTML5でエクスポート。エディター上からサーバー起動して実行した
